...
OhdsiRTools::checkUsagePackage("EsrdAdCardiacSafety")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EsrdAdCardiacSafety.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EsrdAdCardiacSafety.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "EsrdAdCardiacSafety")
...
OhdsiRTools::createRenvLockFile("EsrdAdCardiacSafety")
